        ...
        <div className="flex flex-col items-center h-[100vh] gap-y-4 w-16 bg-brand shadow-lg border-r border-primary">
            <div className="text-center mt-4">
                <button 
                    ...
                    className={`p-2 rounded-lg ${darkMode ? 'bg-gray-700 dark:text-gray-200' : 'bg-gray-200 text-yellow-500'} hover:opacity-80 transition-all duration-300`}
            ...
            <div className="text-center">
                <IoMdHome className="text-4xl text-variant"/>
            </div>
        </div>
    )
}